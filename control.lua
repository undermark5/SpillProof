function on_inventory_grow(player, old_armor_bonus, new_armor_bonus)
    ...
    if global["backup_inventories"] == nil then
        global["backup_inventories"] = {}
    end
...
function on_inventory_shrink(player, old_armor_bonus, new_armor_bonus)
...
function on_armor_changed(evt)
    ...
    if armor_bonuses == nil then
        global["armor_bonus"] = {}
        armor_bonuses = global["armor_bonus"]
    end
